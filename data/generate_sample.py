...
import traceback
# 图像
img_dir = r"D:\materials_old\datasets\CelebA\Img\img_celeba\img_celeba"
# 框的标注
anno_src = r"D:\materials_old\datasets\CelebA\Anno\list_bbox_celeba.txt"
# 关键点的标注
anno_landmarks_src = r"D:\materials_old\datasets\CelebA\Anno\list_landmarks_celeba.txt"
# 结果保存
    ...
    try:
        ...
        for i, (anno_line, landmarks) in enumerate(zip(anno_list, landmarks_list)):
            ...
            for _ in range(5):
                ...
                # 计算两个坐标点和5个关键点的偏移率
                # （老 - 新） / 新
                # 误差是人为构建出来的，可正向使用，也可以反向使用，可以任意设置
